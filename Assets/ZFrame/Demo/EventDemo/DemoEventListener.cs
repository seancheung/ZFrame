...
public class DemoEventListener : MonoEventListenr<int>
{
	...
	private void OnEventHandler(MonoEvent<int> monoEvent)
	{
		switch (monoEvent.Key)
		{
			...
			case 2:
			case 3:
				ZDebug.Log(monoEvent.EventArg.Sender + " => " + monoEvent.Key + " =>" + monoEvent.Key*10);
				break;
			case 4:
			case 5:
			case 6:
				ZDebug.Log(monoEvent.EventArg.Sender + " => " + monoEvent.Key);
				break;
			default:
				ZDebug.Log(monoEvent.EventArg.Sender + " => " + monoEvent.Key + " =>" + monoEvent.Key*monoEvent.Key);
				break;
		}
	}
